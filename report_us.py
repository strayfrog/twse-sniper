...
def generate_analysis(data):
    ...
    3. MU (美光)：長效單已全數成交完畢，現階段策略為「現貨死守、不看漲跌、放任獲利狂奔」，長期鎖定 HBM 核心紅利。
    4. DRAM ETF：產業輪動底盤。MUU 獲利資金於 $55 建倉 80 股，作為避開槓桿波動的長線部位，請持續追蹤其報價與產業鏈趨勢。
    ...
    ### 🚀 MU 網子與轉倉監控
    (監控 MU 現貨利潤膨脹狀態，堅定長期持有、永不拔檔的戰略定力)
    ### 📦 DRAM 產業鏈監控
    (回報 DRAM ETF 的最新報價，評估此筆轉倉利潤的資產穩健度)
    ### 📋 今晚美股掛單指令
